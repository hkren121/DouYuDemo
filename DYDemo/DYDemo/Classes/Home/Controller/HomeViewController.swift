...
class HomeViewController: UIViewController {
    ...
    private lazy var pageContentView : PageContentView = { [weak self] in
        //1.确定内容的frame
        let contentH = KScreenH - KStatusBarH - KNavigetionBarH - KTitleViewH - KTabBarH
        let contentFrame = CGRect(x: 0, y:KStatusBarH + KNavigetionBarH + KTitleViewH, width: KScreenW, height: contentH)
